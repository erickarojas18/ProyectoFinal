  ...
  <div class="form-wrapper">
    <div class="container mt-5">
      ...
      <form method="POST" enctype="multipart/form-data" action="<?= current_url() ?>">
        ...
        <div class="form-group">
          <label for="user_id">ID de Amigo:</label>
          <input type="number" name="user_id" id="user_id" class="form-control" value="<?= htmlspecialchars($arbol['user_id']) ?>" required>
        </div>
        <div class="form-group">
